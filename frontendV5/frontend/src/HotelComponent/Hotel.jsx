...
const Hotel = () => {
  ...
  //const [room, setRoom]=useState(5);//for available room
  ...
  let hotel_user = JSON.parse(sessionStorage.getItem("active-hotel"));
  ...
  const handleBookingInput = (e) => {
    ...
    //setRoom(hotel.totalRoom-booking.totalRoom)
  };
  ...
  const bookHotel = (e) => {
    if (user == null) {
      ...
      //formData.append("availRoom",booking.availRoom);
          ...
          <div class="card form-card border-color custom-bg">
            ...
            <div class="card-footer custom-bg">
              <div className="d-flex justify-content-between">
                ...
                <p class="text-color">
                  <b>Total Room : {hotel.totalRoom}</b><br/>
                  {/* <b>Avail Room : {hotel.totalRoom-booking.totalRoom}</b>  */}
                </p>
              </div>
                ...
                <form class="row g-3" onSubmit={bookHotel}>
                  ...
                  <div class="col-auto">
                    ...
                    <input
                      ...
                      min={currentDate && booking.checkIn}
                      required
                    />
                  </div>
                  <div class="col-auto">
