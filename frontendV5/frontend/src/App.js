...
import ViewMyApprovedHotelBookings from "./BookingComponent/ViewMyApprovedHotelBookings";
import VerifyBooking from "./BookingComponent/VerifyBooking";
import ViewMyHotels from "./HotelComponent/ViewMyHotels";
import ViewPendingHotels from "./HotelComponent/ViewPendingHotels";
import ApproveHotel from "./HotelComponent/ApproveHotel";
import ViewMyApprovedBooking from "./BookingComponent/ViewMyApprovedBooking";
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/home/all/hotel/facility" element={<HomePage />}/>
        <Route
          path="/home/hotel/location/:locationId/:locationName"
          element={<HomePage />}
        />
        <Route
          path="/home/hotel/facility/:facilityId/:facilityName"
          element={<HomePage />}
        />
        ...
        <Route path="user/hotel/bookings/approved" element={<ViewMyApprovedBooking />} />
        <Route
          path="user/hotel/bookings/all"
          element={<ViewMyHotelBookings />}
        />
        <Route
          path="user/hotel/bookings/approved/hotels"
          element={<ViewMyApprovedHotelBookings />}
        />
        <Route
          path="/hotel/verify/booking/:bookingId"
          element={<VerifyBooking />}
        />
        <Route path="/myhotels/all" element={<ViewMyHotels />} />
        <Route
          path="/admin/pendingHotels/all"
          element={<ViewPendingHotels />}
        />
        <Route path="/admin/hotel/approve" element={<ApproveHotel />} />
      </Routes>
    </div>
  );
}
